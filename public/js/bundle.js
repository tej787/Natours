...
var displayMap = exports.displayMap = function displayMap() {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var map = new ol.Map({
      ...
      }) // Disable zooming on scroll, moving the map, and double click zoom
    });
    ...
    locations.forEach(function (loc) {
      ...
      tooltip.innerHTML = "Day ".concat(loc.day, ": ").concat(loc.description);
      ...
      element.addEventListener('click', function () {
        ...
        window.location.href = "https://www.google.com/maps/search/?api=1&query=".concat(loc.coordinates[1], ",").concat(loc.coordinates[0]);
      });
    });
...
exports.redirectToReviewPage = exports.addreview = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your review has been added successfully! This will be help us to improve service! \n Thank You!!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
var redirectToReviewPage = exports.redirectToReviewPage = function redirectToReviewPage() {
  // Get the current URL
  var currentUrl = window.location.href;

  // Append "/review" to the current URL
  var reviewUrl = "".concat(currentUrl, "/review");
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51OxUi5EgaKz8SsyvrAggaTIQFeGXiPwp6B2QbkMkbssdBxzPAmkjeIE4c73J6zzAeBNp1QgKoO0yky1oz48XUgMz00o6uLo51v');
...
if (addreviewBtn) {
  addreviewBtn.addEventListener('click', function (e) {
    (0, _review.redirectToReviewPage)();
  });
}
if (submitreviewBtn) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            tour = document.getElementById('tourId').value;
            (0, _review.addreview)(review, rating, tour);
          case 5:
          case "end":
            return _context2.stop();
        }
